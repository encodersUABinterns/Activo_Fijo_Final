 ...
 * @author Augustito
 */
public class vistafaculd_subareas extends javax.swing.JFrame {

    /**
     * Creates new form vistafaculd_subareas
     */
    public vistafaculd_subareas() {
        initComponents();
        mostrar("");
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listado de Facultades o Subareas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 0)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistafaculd_subareas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistafaculd_subareas().setVisible(true);
            }
        });
    }
